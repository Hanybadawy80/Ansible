...
MAP_FILE_MIME_TYPE_TO_EXTENSION = {

    'application/vnd.ms-outlook':'.msg', # msg file
    ...
    'audio/amr':'.amr',
    'audio/x-aiff':'.aiff',
    'application/ogg': '.ogg',  # OGG audio files
    ...
    #'application/x-msdownload': '.msi',  # Microsoft Windows installer files
    ...
    'application/vnd.android.package-archive': '.apk',  # Android application files
